...
export default function Login() {
    ...
    async function handleLogin() {
        ...
        try {
            ...
            if (role === "superusuario") router.push("/admin");
            else if (role === "psicologo") router.push("/dashboard-psico");
                ...
                <div className="anim-card-wrapper w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden flex min-h-[540px]">
                    <div className="hidden md:flex md:w-2/5 relative flex-col justify-end p-8"
                        ...
                        <div style={{ position: "relative", zIndex: 10 }}>
                            <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 600, fontSize: "1.6rem", color: "white", lineHeight: 1.2 }}>Un espacio para ti</h2>
